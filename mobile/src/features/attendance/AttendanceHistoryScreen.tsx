  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {canCorrect ? (
          <TouchableOpacity onPress={() => navigateTo(navigation, 'AttendanceCorrection', user)}>
              ...
              return (
                <View key={record.date} style={styles.recordCard}>
                  ...
                  <View style={styles.recordActions}>
                    {canCorrect && record.status === 'MISSING_PUNCH' && (
                      <TouchableOpacity
                        style={styles.correctionBtn}
                        onPress={() =>
                          navigateTo(navigation, 'AttendanceCorrection', user, { date: record.date })
                        }
                      >
