...
public class EmployeeSelfServiceController : ControllerBase
{
    ...
    public EmployeeSelfServiceController(ZayraDbContext db, ILetterService letters, PdfRenderGate pdfGate, Application.Leave.ILeaveService leaveService, IAttendanceService attendanceService, IHrLetterIssuer letterIssuer)
    {
        _letters = letters;
        _db = db;
        _pdfGate = pdfGate;
