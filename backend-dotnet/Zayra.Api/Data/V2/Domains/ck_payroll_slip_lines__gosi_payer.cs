...
/// <summary>
/// Closed set behind <c>payroll_slip_lines.gosi_payer</c>, specified by TARGET_SCHEMA.md revision 7 SS9 row 38
/// as the CHECK constraint <c>ck_payroll_slip_lines__gosi_payer</c>.
/// <para>
...
/// </para>
/// </summary>
public static class ck_payroll_slip_lines__gosi_payer
{
    public const string Table = "payroll_slip_lines";
    public const string Column = "gosi_payer";
    public const string ConstraintName = "ck_payroll_slip_lines__gosi_payer";
