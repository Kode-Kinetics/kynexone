...
/// <summary>
/// Closed set behind <c>statutory_rules.payer</c>, specified by TARGET_SCHEMA.md revision 7 SS9 row 38
/// as the CHECK constraint <c>ck_statutory_rules__payer</c>.
/// <para>
...
/// </para>
/// </summary>
public static class ck_statutory_rules__payer
{
    public const string Table = "statutory_rules";
    public const string Column = "payer";
    public const string ConstraintName = "ck_statutory_rules__payer";
    public const bool NullAllowed = true;

    public const string Employee = "Employee";
    public const string Employer = "Employer";

    /// <summary>Every legal value, in the order SS9 row 38 declares them.</summary>
