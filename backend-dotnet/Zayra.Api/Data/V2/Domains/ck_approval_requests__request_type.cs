...
/// <summary>
/// Closed set behind <c>approval_requests.request_type</c>, enforced by the database CHECK constraint
/// <c>ck_approval_requests__request_type</c>. The class name is that constraint name verbatim — KynexDomainsTests
/// asserts the two are identical, so renaming this type breaks the build, not production.
/// </summary>
public static class ck_approval_requests__request_type
{
    public const string Table = "approval_requests";
    public const string Column = "request_type";
    public const string ConstraintName = "ck_approval_requests__request_type";
