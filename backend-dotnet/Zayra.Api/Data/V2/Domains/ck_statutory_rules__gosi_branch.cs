...
/// <summary>
/// Closed set behind <c>statutory_rules.gosi_branch</c>, specified by TARGET_SCHEMA.md revision 7 SS9 row 37
/// as the CHECK constraint <c>ck_statutory_rules__gosi_branch</c>.
/// <para>
...
/// </para>
/// </summary>
public static class ck_statutory_rules__gosi_branch
{
    public const string Table = "statutory_rules";
    public const string Column = "gosi_branch";
    public const string ConstraintName = "ck_statutory_rules__gosi_branch";
