...
/// <summary>
/// Closed set behind <c>payroll_slip_lines.kind</c>, enforced by the database CHECK constraint
/// <c>chk_payroll_slip_lines_kind</c>. The class name is that constraint name verbatim — KynexDomainsTests
/// asserts the two are identical, so renaming this type breaks the build, not production.
/// </summary>
public static class chk_payroll_slip_lines_kind
{
    public const string Table = "payroll_slip_lines";
    public const string Column = "kind";
    public const string ConstraintName = "chk_payroll_slip_lines_kind";
