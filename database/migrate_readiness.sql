...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730044113_AddCompanyIdToGccComplianceSetting') THEN
    DROP INDEX "IX_gcc_compliance_settings_tenant_id_country_code";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730044113_AddCompanyIdToGccComplianceSetting') THEN
    ALTER TABLE gcc_compliance_settings ADD company_id uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730044113_AddCompanyIdToGccComplianceSetting') THEN
    CREATE INDEX "IX_gcc_compliance_settings_tenant_id_company_id" ON gcc_compliance_settings (tenant_id, company_id);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730044113_AddCompanyIdToGccComplianceSetting') THEN
    CREATE UNIQUE INDEX "IX_gcc_compliance_settings_tenant_id_company_id_country_code" ON gcc_compliance_settings (tenant_id, company_id, country_code);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730044113_AddCompanyIdToGccComplianceSetting') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260730044113_AddCompanyIdToGccComplianceSetting', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730110532_AddEmployeeReadinessSnapshot') THEN
    ALTER TABLE employees ADD activation_blockers_count integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730110532_AddEmployeeReadinessSnapshot') THEN
    ALTER TABLE employees ADD readiness_evaluated_at_utc timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730110532_AddEmployeeReadinessSnapshot') THEN
    ALTER TABLE employees ADD readiness_state character varying(20) NOT NULL DEFAULT 'Blocked';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730110532_AddEmployeeReadinessSnapshot') THEN
    CREATE INDEX "IX_employees_tenant_id_readiness_state" ON employees (tenant_id, readiness_state);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730110532_AddEmployeeReadinessSnapshot') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260730110532_AddEmployeeReadinessSnapshot', '8.0.11');
    END IF;
END $EF$;
COMMIT;
